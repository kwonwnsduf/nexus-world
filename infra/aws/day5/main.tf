...
locals {
  name          = "${var.project_name}-${var.environment}-day5"
  artifact_name = "${var.project_name}-${var.environment}-${data.aws_caller_identity.current.account_id}-${var.aws_region}-day5"
}
...
resource "aws_security_group" "web" {
  name        = "${local.name}-web"
  description = "Public Nginx only; administration uses SSM"
  vpc_id      = aws_vpc.this.id
